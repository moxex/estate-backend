...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_('City'), max_length=180, default='Kano')
    postal_code = models.CharField(verbose_name=_('Postal Code'), max_length=100, default='234')
    street_address = models.CharField(verbose_name=_('Street Address'), max_length=150, default='GRA Avenue')
    ...
    vat = models.DecimalField(verbose_name=_('Property VAT'), max_digits=6, decimal_places=2, default=0.7,
                                    help_text='7.5% property VAT charged',)
    ...
    def final_property_price(self):
        vat_percentage = self.vat
        property_price = self.price
        vat_amount = round(vat_percentage * property_price, 2)
        price_after_vat = float(round(property_price + vat_amount, 2))
