...
urlpatterns = [
    path('all/', views.ListAgentsPropertiesAPIView.as_view(), name='all-properties'),
    ...
    path('update/<slug:slug>/', views.updated_property_api_view, name='update-property'),
    path('delete/<slug:slug>/', views.delete_property_api_view, name='detele-property'),
